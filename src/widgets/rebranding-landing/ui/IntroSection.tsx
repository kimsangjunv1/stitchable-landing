...
export function IntroSection() {
    return (
        <section className="mx-auto w-[min(1920px,calc(100%-48px))] pt-[27px] max-[720px]:w-[min(calc(100%-32px),520px)]">
            <header className="fixed top-0 left-0 flex h-[120px] items-start gap-[38px] max-[720px]:h-[105px] max-[720px]:flex-col max-[720px]:gap-[13px]">
                ...
                >
                    <a
                        className="font-bold text-[#050505]"
                        href="#guide"
                    >
                        GUIDE
                    </a>
            ...
            <div className="min-h-[50svh] flex flex-col justify-center max-[720px]:min-h-[285px]">
