                ...
                <div className="overflow-hidden border border-[var(--adaptive-border)]">
                    ...
                    <div className="grid gap-[1px] bg-[var(--adaptive-border)]">
                        {compare.rows.map(([before, after]) => (
                            <div
                                className="grid grid-cols-1 bg-[var(--adaptive-surface)] tablet:grid-cols-2"
                                key={before}
                            >
                                <div className="p-[2rem] text-[1.7rem] leading-[1.5] text-[var(--adaptive-text-secondary)] tablet:p-[2.4rem]">{before}</div>
                                <div className="border-t border-[var(--adaptive-border)] p-[2rem] text-[1.7rem] font-medium leading-[1.5] tablet:border-l tablet:border-t-0 tablet:p-[2.4rem]">{after}</div>
                            </div>
                        ))}
                    </div>
                </div>
