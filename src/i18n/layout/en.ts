...
export const layoutEn: LayoutMessages = {
    ...
    footer: {
        home: {
            ...
            product: "Product", explore: "Explore", builtBy: "Built by",
        ...
        site: { codi: "CODI", handle: "@kimsangjunv1", developedBy: "Developed and Designed by", author: "kimsangjun", currentLibrary: "current available library", libraries: "agit.\nfivepixels.", githubAria: "GitHub", linkedInAria: "LinkedIn", logoAlt: "fivepixels" },
    },
    megaMenus: [
        { id: "main", label: "MAIN", href: "/", groups: [
            { eyebrow: "PRODUCT", title: "Product", links: [
            ...
            { eyebrow: "WHY", title: "Features and adoption", links: [
        ...
        { id: "guides", label: "GUIDES", href: "/guides/quickstart", groups: [
            { eyebrow: "START", title: "Start", links: [
            ...
            { eyebrow: "REVIEW", title: "Review", links: [
            ...
            { eyebrow: "REFERENCE", title: "Quick reference", links: [
            ...
            ], viewAll: { label: "Open the guides", description: "Start here", href: "/guides/quickstart", icon: "arrow_forward" } },
        ] },
        { id: "docs", label: "DOCS", href: "/docs/setup", groups: [
            { eyebrow: "START", title: "Foundations", links: [
            ...
            { eyebrow: "FEATURES", title: "Features", links: [
            ...
            { eyebrow: "REFERENCE", title: "Reference", links: [
        ...
        { id: "examples", label: "DEMO", href: "/example/01", groups: [
            { eyebrow: "DASHBOARD", title: "Live demo", links: [
            ...
            { eyebrow: "LABS", title: "Test screens", links: [
