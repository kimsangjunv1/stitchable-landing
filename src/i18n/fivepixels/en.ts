        ...
        items: [
            {
                ...
                label: "01 / PINPOINT",
                title: "Click the exact spot",
                description: "Place feedback on the element itself, so nobody has to decode screenshots or ask which button you meant.",
                eyebrow: "MARKER TOOLTIP",
            },
            {
                scene: "feedback-composer",
                label: "02 / DESCRIBE",
                title: "Add the context once",
                titleLine2: "right where it matters",
                description: "Write the change, intent, and owner in one place, then return to the same screen for confirmation.",
                eyebrow: "FEEDBACK COMPOSER",
            },
            {
                scene: "memo-composer",
                label: "03 / NOTE",
                title: "Leave a lightweight memo",
                description: "Capture a quick thought without opening a full feedback ticket, then keep moving through the review.",
                eyebrow: "MEMO COMPOSER",
            },
            {
                scene: "panel-overview",
                label: "04 / OVERVIEW",
                title: "See the whole review surface",
                description: "Open the panel and scan status, owners, and open items without leaving the page under review.",
                eyebrow: "PANEL OVERVIEW",
            },
            {
                scene: "network-monitor",
                label: "05 / NETWORK",
                title: "Catch request issues live",
                description: "Inspect network activity alongside the UI so review notes can point to broken calls, not just broken pixels.",
                eyebrow: "NETWORK MONITOR",
            },
            {
                scene: "feedback-list",
                label: "06 / LIST",
                title: "Browse every pin on the page",
                description: "Jump between feedback items in one list, filter what matters, and reopen the exact marker in place.",
                eyebrow: "FEEDBACK LIST",
            },
            {
                scene: "memo-list",
                label: "07 / MEMOS",
                title: "Keep soft notes beside tickets",
                description: "Collect lightweight memos in one place so temporary thoughts stay visible without cluttering feedback.",
                eyebrow: "MEMO LIST",
            },
            {
                scene: "page-brief",
                label: "08 / BRIEF",
                title: "Summarize what this route needs",
                description: "Give reviewers a short page brief so everyone lands with the same context before they start pinning.",
                eyebrow: "PAGE BRIEF",
            },
            {
                scene: "my-tasks",
                label: "09 / TASKS",
                title: "Focus on what you own",
                description: "Cut the noise down to your assignments and clear the queue without hunting through every thread.",
                eyebrow: "MY TASKS",
            },
            {
                scene: "project-health",
                label: "10 / HEALTH",
                title: "Read project review health",
                description: "Check progress across routes and owners so stalled feedback stands out before release day.",
                eyebrow: "PROJECT HEALTH",
            },
            {
                scene: "element-hover-inspect",
                label: "11 / HOVER",
                title: "See what is selectable",
                description: "Hover the live UI to reveal reportable targets, so reviewers know exactly where a pin can land.",
                eyebrow: "ELEMENT HOVER INSPECT",
            },
            {
                scene: "element-inspector",
                label: "12 / INSPECT",
                title: "Read the element metadata",
                description: "Open the inspector for ids, hierarchy, and structure details when a visual note alone is not enough.",
                eyebrow: "ELEMENT INSPECTOR",
            },
            {
                scene: "device-preview",
                label: "13 / DEVICE",
                title: "Check feedback across viewports",
                description: "Preview the same screen at different sizes so responsive issues get marked where they actually break.",
                eyebrow: "DEVICE PREVIEW",
            },
            {
                scene: "feedback-thread",
                label: "14 / THREAD",
                title: "Reply in the same context",
                description: "Keep discussion on the marker itself, so decisions stay attached to the UI instead of disappearing in chat.",
                eyebrow: "FEEDBACK THREAD",
            },
            {
                scene: "settings",
                label: "15 / SETTINGS",
                title: "Tune how fivepixels behaves",
                description: "Adjust locale, appearance, and review preferences so the tool matches the way your team works.",
                eyebrow: "SETTINGS",
            },
            {
                scene: "settings-customization",
                label: "16 / CUSTOMIZE",
                title: "Shape the panel for your team",
                description: "Customize fields and presentation so the review UI reflects your process, not a generic checklist.",
                eyebrow: "SETTINGS CUSTOMIZATION",
            },
            {
                scene: "settings-marker",
                label: "17 / MARKERS",
                title: "Control how pins look and act",
                description: "Configure marker behavior so every pin stays readable, consistent, and easy to find on dense screens.",
                eyebrow: "SETTINGS MARKER",
            },
            {
                scene: "notifications",
                label: "18 / ALERTS",
                title: "Stay on top of new replies",
                description: "Get notified when feedback moves so reviews keep flowing without constant manual checking.",
