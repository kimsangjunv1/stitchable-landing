...
export const ko: LandingMessages = {
    ...
    landing: {
        ...
        hero: {
            ...
            description: "실제 `DOM` 요소에 피드백을 남기고, UI가 바뀌어도 `마커`를 복원할 수 있습니다.\n`스크린샷` 없이도 이슈를 검토할 수 있습니다.",
        ...
        capabilities: {
            items: [
                {
                    title: "실제 DOM에 피드백",
                    description: "`data-report-id`와 `data-report-type`으로\n요소에 직접 피드백을 남길 수 있습니다.",
                    tags: ["DOM", "마커", "선택"],
                },
                {
                    title: "일관된 개발 흐름",
                ...
                },
                {
                    ...
                    description: "Next.js, Vite, CRA 등\nReact 기반 프레임워크를 모두 지원합니다.",
        ...
        trust: {
            title: "검증된 피드백 워크플로우",
            description: "스크린샷 QA를 대체하는 오픈 소스 피드백 레이어입니다.\n실제 화면 위에서 바로 협업할 수 있습니다.",
            stats: [
            ...
            performance: {
                ...
                description: "스크린샷 대신 `DOM 마커`로 피드백하고, UI 변경 후에도 `위치를 복원`합니다.\n필요하면 `GitHub Issue`로 바로 승격할 수 있습니다.",
            },
        },
        libraryGoodPoints: {
        ...
        adoptionPath: {
            ...
            description: "handler 없이 시작하고, 필요할 때 필드·팀·API·GitHub·Slack을 단계적으로 붙일 수 있습니다.",
            steps: [
                {
                    label: "localStorage",
        ...
        techTrust: {
            ...
            description: "의존성 0 + QA 풀스택 UI 트레이드오프를 감안해도, 계약과 번들은 예측 가능합니다.",
            panels: [
                {
        ...
        qualityAssurance: {
            ...
            description: "Vitest, typecheck, build, bundle size, example build가 CI에서 돌아가고 문서·스키마가 정리되어 있습니다.",
            items: [
                {
                    title: "Vitest & CI",
        ...
        benefits: {
            shipping: {
                ...
                items: ["스크린샷·주석 도구 유지보수 시간을 줄일 수 있습니다", "디자이너·개발자·QA 간 컨텍스트 공유가 수월해집니다", "사람과 AI 워크플로우 모두에 표준화된 피드백을 제공합니다"],
            },
            security: {
                title: "호스트 앱과 격리된 UI",
                description: "Shadow Root로 패널·오버레이·마커가\n호스트 스타일과 완전히 분리됩니다.",
                items: ["CSS import 불필요 — Shadow DOM으로 격리됩니다", "localStorage 우선, 서버 API는 선택적으로 연동합니다", "환경·버전·라우트별로 피드백을 분리할 수 있습니다"],
            },
        },
        showcase: {
        ...
        bento: {
            ...
            description: "우측 패널에서 모드를 선택하거나 단축키로 바로 진입합니다.\n커스텀 필드·팀·환경 설정도 같은 레이어에서 처리됩니다.",
            modes: [
                {
                    id: "idle",
                    label: "idle",
            ...
            config: [
                ...
                {
                    title: "환경 분리",
                    description: "devOnly·routeKey·project.env·version으로 scope를 분리합니다",
                    tags: ["devOnly", "routeKey", "env", "version"],
                },
                {
                    title: "다국어 UI",
                    description: "ui.locale ko/en, 브라우저 자동 감지, ui.messages로 문구를 커스터마이즈합니다",
        ...
        workflow: {
            ...
            description: "view 모드 마커를 기준으로 답변·검수(denied / confirm / checkout) 흐름이 이어집니다.\n필요하면 GitHub Issue로 승격할 수 있습니다.",
            steps: [
                {
                    id: "write",
                    label: "01 · report",
                ...
                },
                {
                    ...
                    label: "02 · reply",
                    title: "답변 & 마커 배지",
                    description: "replies가 쌓이면 마커에 +N 배지가 표시되고,\nhover 시 최근 답변을 미리볼 수 있습니다.",
                    status: "suggested",
                },
                {
                    id: "review",
                ...
                },
                {
                    ...
                    description: "github.onCreate로 Issue를 생성하면\nstatus가 git_issued로 변경됩니다.",
                    status: "git_issued",
                },
            ],
        },
            ...
            items: [
                {
                    ...
                    description: "Next.js App Router, Pages Router, Remix 등\nReact 메타 프레임워크를 지원합니다",
                ...
                },
                {
                    ...
                    description: "localhost, 스테이징, 프로덕션 환경별로\n피드백을 분리할 수 있습니다",
        ...
        preview: {
            ...
            progress: ["패널 대기", "피드백 추가", "요소 선택", "피드백 전송", "마커 미리보기", "답변 작성", "이슈 해결"],
            hints: [
                "피드백 추가 버튼을 누르세요",
                "피드백을 남길 요소를 클릭하세요",
                "메시지를 입력하고 전송하세요",
            ...
            mockPage: {
                ...
                section: {
                    ...
                    description: "스테이징 검증 후 프로덕션 승격까지 지연 구간을 빠르게 찾을 수 있습니다.",
                },
                panels: [
                    {
                        title: "API gateway latency",
                        description: "리전별 p95가 200ms를 넘으면 알림이 울립니다. 현재 us-east-1만 임계치에 근접합니다.",
                    },
                    {
                        title: "Background queue depth",
                        description: "이메일·웹훅 워커 큐가 500건 이상 쌓이면 소비자를 자동 스케일합니다.",
                    },
                ],
                table: {
